...
function App() {
  ...
  async function loadData(query, category, page) {
    const baseEndpoint = `https://newsapi.org/v2/top-headlines?country=eg&pageSize=${DEFAULT_PAGE_SIZE}&category=${category}&page=${page}&apiKey=${import.meta.env.VITE_NEWS_API_KEY}`;

    // const baseEndpoint = `https://newsapi.org/v2/top-headlines?country=eg&pageSize=${DEFAULT_PAGE_SIZE}&category=${category}&page=${page}&apiKey=714ef9b8a6ef47d19b4bda6f4f0d100f`;
